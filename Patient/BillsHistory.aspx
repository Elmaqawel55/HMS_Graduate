...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-container">
        <div class="title">Your Bill(s) History</div>

        <asp:Label ID="BHistory" runat="server" CssClass="label-section"></asp:Label>

        <asp:GridView ID="BHistoryGrid" runat="server" CssClass="GridView-d"
            CellPadding="4"
            ForeColor="Black"
            GridLines="None"
            Width="100%"
