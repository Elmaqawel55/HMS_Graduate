...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-container">
        <div class="title">Select a Doctor to View Their Profile</div>

        <asp:Label ID="TDoctor" runat="server" CssClass="label-section"></asp:Label>

        <asp:GridView ID="TDoctorGrid" runat="server" CssClass="GridView-d"
            CellPadding="4"
            ForeColor="Black"
            GridLines="None"
