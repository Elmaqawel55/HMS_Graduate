...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-container">
        <div class="title">Select a Department to View Its Doctors</div>

        <asp:Label ID="TDept" runat="server" CssClass="label-section"></asp:Label>

        <asp:GridView ID="TDeptGrid" runat="server" CssClass="GridView-d"
